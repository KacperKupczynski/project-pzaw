...
from .views import UserList, RandomTextView, ResultCreateView, UserResultsView, UserStatisticsView, RegisterView, AddTextView, TextListView, EditTextView, DeleteTextView
...
urlpatterns = [
    ...
    path('user/<int:user_id>/statistics/', UserStatisticsView.as_view(), name='user_statistics'),
